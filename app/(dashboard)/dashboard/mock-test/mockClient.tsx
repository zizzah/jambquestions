...
export default function MockClient({ userSubjects, userId }: PracticeClientProps) {
  ...
  const handleSelectSubject = (subjectName: string) => {
    ...
    function handleEndSessionTimeout(){
      setTimeout(() => {
        setCurrentSession(null);
        setSelectedSubject(null);
      }, 1000 * selectedQuestionCount * 2); // Assuming each question takes 2 minutes
    };
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-orange-700">
                        Time: <strong>{selectedQuestionCount * 2} minutes</strong>
                      </span>
                    </div>
                  </div>
                </div>
